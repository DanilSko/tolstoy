...
##    return tagWords, attrWords, napisano, zacherknuto, naPolyah, gdebol,\
##           gdemal, gdemalv, pozdnee
...
def return_attr(word, tag, naPolyah, pozdneeWords, gdebol=[], gdemal=[],
                gdemalv=[]):
##    print(3)
##    print(word)
##    print(gdebol)
...
##    kursivOrig = copy.deepcopy(kursiv)
...
##        print(kursiv)
        for word in tagWords:
            if word in kursiv:
                kursiv = kursiv.replace(word, '', 1)
                newTag = return_tag(word, soup, napisano, zacherknuto,
                                 naPolyah)
                break
...
##            print(tag.name)
            ...
            tag.decompose()
##    delete_empty_tags(newTag, path, kursiv)
##    print('***********')
##    print(newTag)
##    print('+++++++++++')
    return newTag
...
##                print(kursiv)
                if len(kursiv) == 0:
                    ...
                    if newTag.name == 'del':
                        print(path)
                        print(newTag)
##                soup = convert_oldTag_into_newTag(soup, tag, newTag)
                
                
##                kursiv = preprocess(tag, tagWords, attrWords, pozdneeWords)
##                if len(kursiv) == 0:
                    counterP += 1
                    
##                    search_for_direct_string(tag, regexp)
####                    types.add(string)
####                    if string == 'div p hi ref hi hi hi':
####                        print(path)
####                        print(tag)
                else:
                    counterNP += 1
